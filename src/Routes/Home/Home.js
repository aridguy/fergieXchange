...
const [passwordGuest, setPasswordGuest] = useState('');
const handleEmailChange = (event) => {
    setEmailGuest(event.target.value);
  };
  const handlePasswordChange = (event) => {
    setPasswordGuest(event.target.value);
  };
  ...
  const handleSubmit = (event) => {
    ...
    console.log('Submitted:', { emailGuest, passwordGuest });
      ...
      <div className="container">
        <div className="row mt-5">
          ...
          <div className="col-md-8 mt-5">
            <div className="contentsHeader text-center">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <span
                    className="txts very-black"
                    data-aos="zoom-in"
                    data-aos-delay="500"
                  >
                    Enjoy a seamless and hassle free experience, trading your
                    gift cards and cryptocurrencies with The Shawn Exchange.
                  </span>
                  <div>
                    <button
                      data-aos="zoom-in"
            ...
            <img
              data-aos="zoom-in"
              data-aos-delay="700"
              className="text-center picsLanding mt-4 full-widths"
              src={LandImage}
              alt="lading page icon"
            />
          </div>
          <div className="col-md-2"></div>
        </div>
        <div className="row mt-5 pt-5">
          <div
            ...
            data-aos-delay="300"
          >
            <h1 className="very-black">
              We pride ourselves in giving the best rate for
              <br />
              <span className="brand"> crypto and gift cards.</span>
            </h1>
            <p className="txts very-black">
              A platform for the best trading experiences of digital assets
              which includes; Gift cards and Cryptocurrencies.
            </p>
          </div>
          <div className="col-md-7">
            <section className="mv-cv">
              <div className="tab-wrap d-flex gap-5 center">
                <button
                  onClick={() => handleCurrentProfileTab("mission")}
                  className="tabs1"
                >
                  Our Mission
                </button>
                <button
                  onClick={() => handleCurrentProfileTab("vision")}
                  className="tabs1"
                >
                  Our Vision
                </button>
                <button
                  onClick={() => handleCurrentProfileTab("values")}
                  className="tabs1"
                >
                  Our Core Values
                </button>
            ...
            <div className="row p-3">
              {currentProfileTab === "mission" && (
                <div
                  className="missionTab"
                  data-aos="fade-up"
                  data-aos-offset="300"
                  data-aos-easing="ease-in-sine"
                  data-aos-delay="200"
                >
                  OpenSea is building the world's most trusted and inclusive
                  peer-to-peer NFT marketplace. OpenSea makes minting,
                  purchasing and selling NFTs frictionless, and offers
                  multi-chain options for creators and collectors of all kinds
                  to own and shape their relationships directly.
                </div>
              )}
                ...
                <section className="innerBackg">
                  <div className="row">
                            ...
                            <div className="row mt-4">
                              <div className="col-md-4">
                                <span
                                  ...
                                  className="mt-3 cursor hyperlinks"
                                >
                                  {" "}
                                  <i className="fas fa-user-group"></i> New
                                  account!
                                </span>
                              </div>
                              <div className="col-md-4">
                                <span
                                  onClick={handleLoginUsers}
                                  className="mt-3 cursor hyperlinks mx-4"
                                >
                                  {" "}
                    ...
                    <div className="col-md-2">
                      <p className="cursor mt-3" onClick={closeLogin}>
                        X
                      </p>
                    </div>
                  </div>
